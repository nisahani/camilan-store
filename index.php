					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="index.php">Snack Mbak Sol</a></div>
								<nav class="main_nav">
									<ul>
									...
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											<div class="home_slider_title">
												<font size="5px">Toko Snack Paling Lengkap</font> Kualitas Terjamin.
											</div>
											<div class="home_slider_subtitle">Selamat Datang di Mbak Sol.id</div>
